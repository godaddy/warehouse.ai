...
module.exports =
  ...
  async function (fastify) {
    fastify.route({
        ...
        async (req, res) => {
          ...
          if (fastify.log.security) {
            fastify.log.security({
              ...
              category: 'file', // see https://www.elastic.co/guide/en/ecs/current/ecs-allowed-values-event-category.html#ecs-event-category-file
      ...
      /* eslint-enable max-statements, max-len */
    });
  };
